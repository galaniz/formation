export default /* html */`
  <frm-tabs id="tabs-delay" delay="100">
    <div>
      <div
        id="tabs-delay-panel-1"
        role="tabpanel"
        aria-labelledby="panel-delay-1-title"
      >
        <h2 id="panel-delay-1-title">Panel 1</h2>
      ...
      <div
        id="tabs-delay-panel-2"
        role="tabpanel"
        aria-labelledby="panel-delay-2-title"
        hidden
      >
        <h2 id="panel-delay-2-title">Panel 2</h2>
      ...
      <div
        id="tabs-delay-panel-3"
        role="tabpanel"
        aria-labelledby="panel-delay-3-title"
        hidden
      >
        <h2 id="panel-delay-3-title">Panel 3</h2>
